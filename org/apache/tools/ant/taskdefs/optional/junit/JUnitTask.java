...
public class JUnitTask extends Task {
    ...
    public String getJacocoAddress() {
        return jacocoAddress;
    }

    public String getJunitCoverDir() {
        return junitCoverDir;
    }
    private String jacocoAddress;
    private String junitCoverDir;
    ...
    public void setJacocoAddress(String jacocoAddress) {
        this.jacocoAddress = jacocoAddress;
    }

    public void setJunitCoverDir(String junitCoverDir) {
        this.junitCoverDir = junitCoverDir;
    }
...
//        System.out.println("junitCoverDir: " + junitCoverDir);
        ...
        if (junitCoverDir != null) {
            ...
            cmd.createArgument().setValue("junitCoverDir=" + junitCoverDir);
            cmd.createArgument().setValue("jacocoPort=" + jacocoPort);
            cmd.createArgument().setValue("jacocoAddress=" + jacocoAddress);
        }
        ...
        if (junitCoverDir != null) {
            ...
            props.put("junitCoverDir", junitCoverDir);
            props.put("jacocoPort", jacocoPort);
            props.put("jacocoAddress", jacocoAddress);
        }
...
//                    finally {
//                        try {
//                            if (JunitConstants.junitCoverDir != null) {
//                                System.out.println("jacoco_" + className + ".exec");
//                                ExecDumpClient execdump = new ExecDumpClient();
//                                ExecFileLoader fileloader = execdump.dump("10.45.14.23", 6300);
//                                File file = new File(JunitConstants.junitCoverDir);
//                                if (!file.exists()) {
//                                    file.mkdirs();
//                                }
//                                File fileCase = new File(JunitConstants.junitCoverDir + "/jacoco_" + className + ".exec");
